...
.controller('phonesController', ['$http', function($http) {
  var current = this;
  /*$http.get('data/phones.json') //reading the phones.json file
    ...
    .error(function(data, status) {
      ...
      current.phones = {}; //return blank record if something goes wrong
    });*/
  current.phones = [
    {
          "age": 0, 
